...
import {FocusModal, Input, Table, Button} from "@medusajs/ui";
...
const PopupUploadImage: FC<PopupUploadImageType> = ({onClose, onUploadImage}) => {
    ...
    const handleChangeCheckBox = (e: ChangeEvent<HTMLInputElement>, image: ImageType) => {
                        ...
                        <div className="w-full py-3 px-2">
                            ...
                            <div className="w-full">
                                <div className="w-full flex items-center">
                                    ...
                                    <Button disabled={selectedFiles === null} onClick={()=>{
                                    ...
                                    {data.data?.map((media) => {
                                        return (
                                            <div id={media?.id}>
                                                ...
                                                {media?.metadata?.type !== "video" && <Image preview={false} src={media?.url}/>}
